...
<Callout type="info">
  [Self Pin](/en/docs/utoo/self-pin) takes precedence over auto-update. A command handed off to a project-pinned release does not automatically update that release.
</Callout>
