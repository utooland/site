...
Utoo<sup>[1]</sup> is an open-source, Rust-based frontend toolchain from Ant Group. It currently includes a package manager and a build tool.

Utoopack is the build tool in the Utoo toolchain. Under the hood, it is built on Turbopack, the Rust bundler behind Next.js.<sup>[2]</sup>

qiankun<sup>[3]</sup> is Ant Group's open-source micro-frontend framework, built on top of single-spa.
...
Umi<sup>[4]</sup> is the open-source version of Ant Group's framework for middle- and back-office applications.
...
Later work added an asynchronous lifecycle proxy and end-to-end coverage for qiankun 2. See Umi PR #13178<sup>[5]</sup> and PR #13354<sup>[6]</sup>.

evjs<sup>[7]</sup> is the open-source version of Ant Group's full-stack framework. Its standalone `@evjs/plugin-qiankun` supports both host and micro apps, including qiankun 3 HTML Entry, mount paths, and lifecycle bridging.

For Utoopack micro apps, evjs also connects to qiankun through a global lifecycle object and a Promise Proxy. See evjs PR #35<sup>[8]</sup> and PR #44<sup>[9]</sup>.
...
Turbopack PR #77773 switched Next.js client chunks from path literals to `document.currentScript`.<sup>[10]</sup> PR #78545 documented and fixed the infinite loop caused by combining `StringLiteral` with content hashes.<sup>[11]</sup>
...
See Utoo Issue #2526<sup>[12]</sup> and Utoo PR #2528<sup>[13]</sup>.
...
See Utoo PR #2790.<sup>[14]</sup>

In Umi's<sup>[4]</sup> qiankun plugin, the micro app HTML initializes:
...
Utoopack also supports `output.publicPath: "auto"`, deriving the asset path from the currently executing script. See Utoo PR #2953.<sup>[15]</sup>
...
See qiankun PR #3131.<sup>[16]</sup>
...
Utoopack once implemented a similar mechanism. `output.entryRootExport` wrapped the entry exports in a configured global variable. See Utoo PR #2550.<sup>[17]</sup>
...
It is the foundation of the current Umi + Utoopack integration. See Umi PR #13178.<sup>[5]</sup>
...
See Umi PR #13354 for the implementation and host/micro-app E2E coverage.<sup>[6]</sup>
...
Umi PR #13178<sup>[5]</sup> introduced the first Umi-side integration.
...
Umi PR #13354<sup>[6]</sup> builds on the global bridge and fixes qiankun 2's asynchronous timing.
...
Umi PR #13367<sup>[18]</sup> extends that E2E coverage to Windows.
...
The current implementation described here still uses classic script mode. See the qiankun 3 ESM Sandbox RFC for the native design.<sup>[19]</sup>
...
Runtime isolation now covers both production and development. See Utoo PR #3251.<sup>[20]</sup>
...
This looks like a small change, but it directly determines whether local micro-frontend development is stable. The behavior is also included in Umi PR #13354.<sup>[6]</sup>
...
We then moved the capability into Turbopack. vercel/next.js PR #88790<sup>[21]</sup> added a configurable `chunk_loading_global` to the Browser Chunking Context.
...
vercel/next.js PR #93488<sup>[22]</sup> later exposed the capability as a Next.js option:
...
We implemented the low-level change in Utoo's Next.js branch through utooland/next.js PR #168<sup>[23]</sup>, then integrated it into Utoopack through utooland/utoo PR #3251.<sup>[20]</sup>
...
After validation, we submitted vercel/next.js PR #95997<sup>[24]</sup>, deriving the HMR Listener from the Chunk Loading Global:
...
[1] Utoo / Utoopack: https://github.com/utooland/utoo

[2] Turbopack in the Next.js repository: https://github.com/vercel/next.js/tree/canary/turbopack

[3] qiankun: https://github.com/umijs/qiankun

[4] Umi: https://github.com/umijs/umi

[5] Umi PR #13178: https://github.com/umijs/umi/pull/13178

[6] Umi PR #13354: https://github.com/umijs/umi/pull/13354

[7] evjs: https://github.com/afx-team/evjs

[8] evjs PR #35 — add `@evjs/plugin-qiankun` for host/micro-app bridging: https://github.com/afx-team/evjs/pull/35

[9] evjs PR #44 — connect Utoopack micro apps through global lifecycles and a Promise Proxy: https://github.com/afx-team/evjs/pull/44

[10] Turbopack PR #77773 — use `document.currentScript` instead of a chunk path literal: https://github.com/vercel/next.js/pull/77773

[11] Turbopack PR #78545 — fix the build hang caused by content hashes with `StringLiteral`: https://github.com/vercel/next.js/pull/78545

[12] Utoo Issue #2526: https://github.com/utooland/utoo/issues/2526

[13] Utoo PR #2528: https://github.com/utooland/utoo/pull/2528

[14] Utoo PR #2790: https://github.com/utooland/utoo/pull/2790

[15] Utoo PR #2953: https://github.com/utooland/utoo/pull/2953

[16] qiankun PR #3131: https://github.com/umijs/qiankun/pull/3131

[17] Utoo PR #2550: https://github.com/utooland/utoo/pull/2550

[18] Umi PR #13367: https://github.com/umijs/umi/pull/13367

[19] qiankun 3 ESM Sandbox RFC: https://github.com/umijs/qiankun/blob/next/docs/rfcs/esm-sandbox.md

[20] Utoo PR #3251: https://github.com/utooland/utoo/pull/3251

[21] Turbopack support for `chunk_loading_global`: https://github.com/vercel/next.js/pull/88790

[22] Next.js support for `turbopack.chunkLoadingGlobal`: https://github.com/vercel/next.js/pull/93488

[23] HMR Listener isolation in Utoo's Next.js branch: https://github.com/utooland/next.js/pull/168

[24] Turbopack HMR Listener isolation: https://github.com/vercel/next.js/pull/95997
