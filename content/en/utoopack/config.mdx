...
| `styledComponents` | Enable styled-components transform |
| `less` | Less preprocessor config |
| `sass` | Sass/SCSS preprocessor config |
| `inlineCss` | CSS injection via style tags |
...
| `react` | `object` | React transform (`runtime`, `importSource`) |
